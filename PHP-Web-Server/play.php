<html>
<head>
<title><?php $name = str_replace('_', ' ', $_REQUEST["c"]); echo $name; ?>BOOT - Denver</title>
...
<?php
printf("<source type=\"application/vnd.apple.mpegurl\" src=\"app\master.php?id=%s\">", $_REQUEST["id"]);
?>
</video>
</body>
<script>
